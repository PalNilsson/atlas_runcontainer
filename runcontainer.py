...
def input():
    ...
    # without PoolFileCatalogs. I expect the task input to be split by the system 
    # and the application not knowing.
...
if __name__ == "__main__":
    ...
    if args.debug:
        logging.basicConfig(filename='run_container.log', level=logging.DEBUG, format=format_str)
    else:
        logging.basicConfig(filename='run_container.log', level=logging.INFO, format=format_str)
